...
<div class="modal-body clearfix npr section-model">
			...
			<div class="scroll" style="height: 200px;overflow-y:scroll;">
	  	 	...
	  	 	<div class="form-group">
				<label class="col-sm-3 control-label" for="fee_type"> <?php echo __('Qualification Name'); ?> <span class="require-field" style="line-height: 30px;">*</span></label>
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<a class="btn btn-default btn-add-cat" href="#" style="float: left;width: auto;border-radius: 0;padding: 5px 10px;box-shadow: none;font-size: 14px;line-height: 18px;margin: 2px 0;"><?php echo __('Add New Qualification'); ?></a>
				</div>
			</div>			
</div>
