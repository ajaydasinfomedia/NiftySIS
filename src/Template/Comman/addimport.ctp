...
<div class="row">			
	<ul role="tablist" class="nav nav-tabs panel_tabs">
		...
		<li class="active">
			<?php  
			if(isset($edit))
				echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-plus-circle fa-lg')) . __('Update Import'),array('controller'=>'Comman','action' => 'addimport',$row['import_id']),array('escape' => false));
			else
				echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-plus-circle fa-lg')) . __('New Import'),array('controller'=>'Comman','action' => 'addimport'),array('escape' => false));
			?>
		</li>
		<li class="">
		...
		<li class="">
			<?php  
			echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-plus-circle fa-lg')) . __('New Export'),array('controller'=>'Comman','action' => 'addexport'),array('escape' => false));
			?>
		</li>
	</ul>
</div>
<div class="row">			
		<div class="panel-body">
			<?php echo $this->Form->Create('form1',['id'=>'formID','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'addimport']]);?>
				...
				<div class="form-group">
					<div class="col-md-2 col-sm-2 col-xs-12 label_float" style="line-height:38px;"><?php echo $this->Form->label(__('')); ?></div>
