...
<div class="print_show">
	...
	<div class="mainarea">
		...
		<div class="lastdiv">
			<div class="textcr first">Invoice <br><b style="text-align:right;">#'.$income_data['income_id'].'</b></div>
...
<center>
 <?php 
 echo $this->Html->link(__('Print'),array('action' => 'incomeprint',$this->Setting->my_simple_crypt($income_data['income_id'],'e')),array('class'=>'btn btnview btn-info printbtn','target'=>'top'))."&nbsp;";
 echo $this->Html->link(__('PDF'),array('action' => 'incomepdf',$this->Setting->my_simple_crypt($income_data['income_id'],'e')),array('class'=>'btn btnview btn-info','target'=>'top')); ?>
</center>