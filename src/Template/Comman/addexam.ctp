			...
			<?php echo $this->Form->Create('form1',['id'=>'formID','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'addexam']]);?>
				<div class="form-group">
							...
							<div class="col-md-10 col-sm-10 col-xs-12">
								<?php echo $this->Form->input('',array('name'=>'exam_name','class'=>'form-control validate[required,maxSize[50]]','PlaceHolder'=> __('Enter Exam Name ')));?>
							</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-8 col-sm-8 col-xs-12 export_model">
						<select class="form-control validate[required,maxSize[50]]" id="term_id" name="term_id">
							...
							?>
							<option value="<?php echo $fetch_data['term_id'];?>" class="room_cat_<?php echo $fetch_data['term_name'];?>">
				...
				<div class="form-group">
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<?php echo $this->Form->input('passmarks',array('type'=>'number','min'=>'10','name'=>'pass_mark','class'=>'form-control validate[required,maxSize[5]] passmarks','PlaceHolder'=> __('Passing Marks of Exam'),'min'=>0,'max'=>1000));?>
					</div>
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<?php echo $this->Form->input('totalmarks',array('type'=>'number','min'=>'20','name'=>'total_mark','class'=>'form-control validate[required,maxSize[5]] totalmarks','PlaceHolder'=> __('Total Marks of Exam'),'min'=>0,'max'=>1000));?>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-2 col-sm-2 col-xs-12 label_float"><?php echo $this->Form->label(__('Exam Date '));?> <span class="require-field">*</span> </div>
					<div class="col-md-4 col-sm-10 col-xs-12 datepickericon">
						<?php echo $this->Form->input('',array('name'=>'exam_date','id'=>'exam_date','class'=>'form-control validate[required]','PlaceHolder'=> __('Enter Exam date ')));?>
					</div>
					...
					<div class="col-md-4 col-sm-4 col-xs-12 datepickericon">
						<?php echo $this->Form->input('',array('name'=>'exam_end_date','id'=>'exam_end_date','class'=>'form-control validate[required]','PlaceHolder'=> __('Exam End Date ')));?>
					</div>
				</div>
				...
				<div class="form-group">
							...
							<div class="col-md-10 col-sm-10 col-xs-12">
								<?php echo $this->Form->input('',array('name'=>'exam_comment','type'=>'textarea','class'=>'form-control validate[maxSize[150]]','PlaceHolder'=> __('Enter Exam Comment ')));?>
							</div>
				</div>
				...
				<div class="form-group">
							...
							<?php echo $this->Form->input(__('Add Exam'),array('type'=>'submit','name'=>'add','class'=>'btn btn-success'));?>
							</div>
				</div>
			<?php $this->Form->end(); ?>
