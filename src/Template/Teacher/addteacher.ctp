...
<div class="row">			
		<div class="panel-body">
			<?php echo $this->Form->Create('form1',['id'=>'formID','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'addteacher']]);?>
				<fieldset>
				...
				<div class="form-group">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<select class="form-control validate[maxSize[50]]" name="classname[]" multiple="multiple" id="class_name">
				...
				<div class="form-group" >
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								...
								<?php echo $this->Form->input('',array('class'=>'file','id'=>'image','type'=>'file','name'=>'docume','PlaceHolder'=> __('Upload Document')));?>
							</div>							
				...
				<div class="form-group">
							...
							<div class="col-md-2 col-sm-2 col-xs-12 label_float"><?php echo $this->Form->label('Submitted Documents');?></div>
							<div class="col-md-4 col-sm-4 col-xs-12">
							
								<?php  echo $this->Form->input('', array('class'=>'validate[minCheckbox[2]] checkbox','name'=>'submitted_document','type' => 'select','multiple' => 'checkbox','options' => array('cv' => __('Curriculum Vitae'),'edu_certificate' => __('Education Certificate'),'experience_certificate'=>__('Experience Certificate')),'default' => array(''))); ?>
							</div>
				...
				<div class="form-group">
							...
							<div class="col-md-4 col-sm-4 col-xs-12 tea_button">
								<?php echo $this->Form->input(__('Add Teacher'),array('type'=>'submit','name'=>'add','class'=>'btn btn-success'));?>
							</div>
				</div>
			<?php $this->Form->end(); ?>
