				...
				<ul role="tablist" class="nav nav-tabs panel_tabs">
					...
					{ ?>
					  ...
					  <li class="active">
						<?php  
						if(isset($edit))
							echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-plus-circle fa-lg')) . __('Edit Income'),array('controller'=>'Comman','action' => 'addincome',$this->Setting->my_simple_crypt($incomerecord['income_id'],'e')),array('escape' => false));
						else
							echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-plus-circle fa-lg')) . __('Add Income'),array('controller'=>'Comman','action' => 'addincome'),array('escape' => false));?> 	
					  </li>
					  <li>
...
<div class="row">			
		<div class="panel-body">
			<?php echo $this->Form->Create('form1',['id'=>'formID','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'addpayment']]);?>
				...
				<div id="custom_label">
						<div class="form-group">
						<label class="col-md-2 col-sm-2 col-xs-12 control-label label_float" for="income_entry"><?php echo __('Income Entry');?><span style="color:red;"><?php echo " *"; ?></span><span class="require-field">*</span></label>
