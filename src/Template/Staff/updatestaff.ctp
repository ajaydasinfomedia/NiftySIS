...
<div class="row">
	<ul role="tablist" class="nav nav-tabs panel_tabs">				  
		...
		<li class="active">		
			<?php  echo $this->Html->link($this->Html->tag('i', '  ', array('class' => 'fa fa-pencil-square-o fa-lg')) . __('Edit Support Staff'),['controller' => 'Staff', 'action' => 'updatestaff',$this->Setting->my_simple_crypt($it['user_id'],'e')],['escape' => false]);?>
		</li>
	</ul>	
</div>
<div class="row">			
