...
$(document).ready(function() {
	...
	$('#teacherattendance').DataTable({responsive: true});
...
<div class="row schooltitle">			
	<ul role="tablist" class="nav nav-tabs panel_tabs">				  
		<li class="active">		
			<?php  echo $this->Html->link($this->Html->tag('i', '  ', array('class' => 'fa fa-list-ul fa-lg')) . __('View Attendance'),['controller' => 'Teacher', 'action' => 'teacherattendance',$this->Setting->my_simple_crypt($id,'e')],['escape' => false]);?>
		</li>
	</ul>	
</div>
...
<div class="row">			
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 button-possition teacerattendsubmit">
		...
		if(isset($_REQUEST['view_attendance']))
		{
			if(isset($attendance))
			{
				...
				$l=0;
				?>
				<p style="margin-top:20px;margin-left: 15px;"><b><?php echo __('Teacher Name :'); ?> <?php echo $name;?></b></p>
				<table id="teacherattendance"  class="table col-md-12">
				<thead>
					<tr>
