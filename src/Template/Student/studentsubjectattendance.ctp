<script>
		jQuery(document).ready(function() {	
			...
			jQuery("#date_of_birth20").datepicker({
				numberOfMonths: 1,
				dateFormat: 'yy-mm-dd',  
				maxDate : new Date(),
				onSelect: function() {
		   ...
		   jQuery("#date_of_birth21").datepicker({     
				numberOfMonths: 1,
				dateFormat: 'yy-mm-dd',  
				maxDate : new Date(),
				onSelect: function() {
...
<div class="row schooltitle">			
	<ul role="tablist" class="nav nav-tabs panel_tabs">				  
		<li>		
			<?php  echo $this->Html->link($this->Html->tag('i', '  ', array('class' => 'fa fa-list-ul fa-lg')) . __('View Attendance'),['controller' => 'Student', 'action' => 'studentattendance',$this->Setting->my_simple_crypt($id,'e')],['escape' => false]);?>
		</li>
		<li class="active">	
	...
	<div class="panel-body">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 attenddatepickericon">
				...
				<div class="col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
					...
					if(isset($_REQUEST['sdate']))
					{
						...
						echo $this->Form->input('',array('value'=>$s_date,'id'=>'date_of_birth20','name'=>'sdate','class'=>'form-control validate[required]','style'=>'padding-left: 30px !important;'));						
					}
					else
					{
			...
			<div class="col-md-3 col-sm-6 col-xs-12 attenddatepickericon">
				...
				<div class="col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
					...
					if(isset($_REQUEST['edate']))
					{
						...
						echo $this->Form->input('',array('value'=>$e_date,'id'=>'date_of_birth21','name'=>'edate','class'=>'form-control validate[required]','style'=>'padding-left: 30px !important;'));						
					}
					else
					{
		...
		if(isset($_REQUEST['view_attendance']))
		{
			if(isset($attendance))
			{
				...
				$t=0;
				?>
				<p style="margin-top:20px;"><b><?php echo __('Student Name :');?> <?php echo $name;?></b> , <b><?php echo __('Subject Name :');?> <?php echo $sub_name;?></b></p>
				...
				{
					echo "<tr>
						<td>".date($stud_date, strtotime($atted['attendance_date']))."</td>
						<td>".date("D", strtotime($atted['attendance_date']))."</td>
						<td>";
