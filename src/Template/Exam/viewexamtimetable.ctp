...
<div class="row">			
	<ul role="tablist" class="nav nav-tabs panel_tabs">		
		...
		<li class="active">
			<?php  echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-list fa-lg'))  . __(' Exam Time Table'),['controller'=>'Exam','action' => 'viewexamtimetable', $this->Setting->my_simple_crypt($exam_id,'e')],['escape' => false]);?>  
		</li>  	
	</ul>
</div>
...
<div class="panel-body">
	...
	<div class="col-md-12 col-sm-12 col-xs-12">				
		<div class="form-group">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="row">
					<table class="table info viewexamtimetable table-striped" cellspacing="0" width="100%" style="border: 1px solid #000000;text-align: center;margin-bottom: 0px;">
						<thead>
							<tr>
