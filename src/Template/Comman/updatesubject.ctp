...
<div class="row">
	 <ul role="tablist" class="nav nav-tabs panel_tabs">				  
		...
		<li class="active">		
			<?php  echo $this->Html->link($this->Html->tag('i', '  ', array('class' => 'fa fa-pencil-square-o fa-lg')) . __('Edit Subject'),['controller' => 'Comman', 'action' => 'updatesubject',$it['subid']],['escape' => false]);?>
		</li>
	</ul>	
</div>
<div class="row">			
