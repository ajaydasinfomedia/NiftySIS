...
<div class="row">			
				<ul role="tablist" class="nav nav-tabs panel_tabs">
					...
					<?php  echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-list fa-lg')) . __('Holiday List'),array('controller'=>'Holiday','action' => 'holidaylist'),array('escape' => false));
						?>
...
<div class="row">			
		<div class="panel-body">
			<?php echo $this->Form->Create('form1',['id'=>'formID','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'addholiday']]);?>
				<div class="form-group">
							...
							<div class="col-md-10 col-sm-10 col-xs-12">
								<?php echo $this->Form->input('',array('name'=>'holiday_title','class'=>'form-control validate[required,maxSize[50]]','PlaceHolder'=> __('Enter Holiday Title ')));?>
							</div>
				</div>
				...
				<div class="form-group">
							...
							<div class="col-md-10 col-sm-10 col-xs-12 datepickericon">
								<?php echo $this->Form->input('',array('name'=>'date','id'=>'date_of_birth20','class'=>'form-control validate[required]','PlaceHolder'=> __('Enter Exam date ')));?>
							</div>
				</div>
					...
					<div class="form-group">
							...
							<div class="col-md-10 col-sm-10 col-xs-12 datepickericon">
								<?php echo $this->Form->input('',array('name'=>'end_date','id'=>'date_of_birth21','class'=>'form-control validate[required]','PlaceHolder'=> __('Enter Exam date ')));?>
							</div>
				</div>
				...
				<div class="form-group">
							...
							<?php echo $this->Form->input(__('Add Holiday'),array('type'=>'submit','name'=>'add','class'=>'btn btn-success'));?>
							</div>
				</div>
			<?php $this->Form->end(); ?>
