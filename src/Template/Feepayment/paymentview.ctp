...
<div class="print_show">
	...
	<div class="mainarea">
		...
		<div class="lastdiv">
			<div class="textcr first">Invoice <br><b style="text-align:right;">#'.$payment_info['fees_pay_id'].'</b></div>
...
<?php 
echo $this->Html->link(__('Print'),array('action' => 'paymentviewprint',$this->Setting->my_simple_crypt($payment_info['fees_pay_id'],'e')),array('class'=>'btn btnview btn-info printbtn','target'=>'top'))."&nbsp;";
echo $this->Html->link(__('PDF'),array('action' => 'paymentviewpdf',$this->Setting->my_simple_crypt($payment_info['fees_pay_id'],'e')),array('class'=>'btn btnview btn-info','target'=>'top')); ?>
</center>