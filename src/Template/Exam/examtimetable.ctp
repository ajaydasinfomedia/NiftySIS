	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div class="form-group">
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<select class="form-control validate[required,maxSize[50]]" id="exam_id" name="exam_id">
			...
			<div id="example_wrapper" class="dataTables_wrapper">
				...
				<tbody>					
							...
							<tr>
								...
								<td>
									<div class="datepickericon">
										<input type="text" id="exam_date_<?php echo $i;?>" value="<?php echo date($stud_date,strtotime($single_exam_data[0]['exam_date']));?>" name="date_<?php echo $subject_data['subid'];?>" class="form-control validate[required]" placeholder="Exam Date">
									</div>
								</td>
								<td>
					...
					<tr>
						...
						<td>
							<div class="datepickericon">
								<input type="text" id="exam_date_<?php echo $subject_data['subid'];?>" name="date_<?php echo $subject_data['subid'];?>" class="form-control validate[required]" placeholder="Exam Date">
							</div>
						</td>
						<td>
							<div class="col-md-4 col-sm-4 col-xs-12"><div class="row">
