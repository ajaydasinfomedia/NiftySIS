...
<div class="row">			
		<div class="panel-body">
			...
			<div class="table-responsive">
				<div id="example_wrapper" class="dataTables_wrapper" style="overflow-x: scroll;">
					...
					<tbody>
						...
						foreach($user as $user_data)
						{
							...
							echo "<td>" ."<button type='submit' name='add_single_student_mark' value='".$user_data['user_id']."' class='btn btn-success'>" ?> <?php echo __('Add/Save Mark'); ?> <?php "</button>"."</td>";
							echo "<tr>";
						}
						?>
					</tbody>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="pull-right">
							<?php echo $this->Form->input(__('Update All Marks'),array('type'=>'submit','name'=>'save_all_multiple_subject_marks','class'=>'btn btn-success'));?>
						</div>
					</div>
					</div>
					</div>
