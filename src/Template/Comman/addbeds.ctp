...
<div class="row">			
	<ul role="tablist" class="nav nav-tabs panel_tabs">
		...
		<li class="active">
			<?php  
			if(isset($edit))
				echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-plus-circle fa-lg')) . __('Edit Beds'),array('controller'=>'Comman','action' => 'addbeds',$row['beds_id']),array('escape' => false));
			else
		...
		<div class="panel-body">
			<?php echo $this->Form->Create('form1',['id'=>'formID','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'addhostel']]);?>
				...
				<div class="form-group">
					...
					<div class="col-md-8 col-sm-8 col-xs-12">
						<?php 
							echo @$this->form->select("room_unique_id",$cls,["default"=>$room_unique_id,"name"=>"room_unique_id","empty"=>__("Select Room Unique ID "),"class"=>"form-control validate[required,maxSize[50]]"]);
						?>	
