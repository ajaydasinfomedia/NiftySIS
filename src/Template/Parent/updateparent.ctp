...
<div class="row">	
	<ul role="tablist" class="nav nav-tabs panel_tabs">				  
		...
		<li class="active">		
			<?php  echo $this->Html->link($this->Html->tag('i', '  ', array('class' => 'fa fa-pencil-square-o fa-lg')) . __('Edit Parent'),['controller' => 'Parent', 'action' => 'updateparent',$this->Setting->my_simple_crypt($it['user_id'],'e')],['escape' => false]);?>
		</li>
	</ul>	
</div>
<?php 
			...
			<?php echo $this->Form->Create('$it',['id'=>'formID','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'']]);?>
				...
				<div class="form-group">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<?php echo $this->Form->input('first_name',array('value'=>$it['first_name'],'name'=>'first_name','class'=>'form-control validate[required,custom[onlyLetterSp],maxSize[50]]','PlaceHolder'=> __('Enter First Name')));?>
							</div>

							<div class="col-md-2 col-sm-2 col-xs-12 label_float"><?php echo $this->Form->label(__('Enter Middle Name '));?></div>
							<div class="col-md-4 col-sm-4 col-xs-12">
								<?php echo $this->Form->input('middle_name',array('value'=>$it['middle_name'],'name'=>'middle_name','class'=>'form-control validate[custom[onlyLetterSp],maxSize[50]]','PlaceHolder'=>__('Enter Middle Name')));?>
							</div>
				</div>
				<div class="form-group">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<?php echo $this->Form->input('last_name',array('value'=>$it['last_name'],'name'=>'last_name','class'=>'form-control validate[required,custom[onlyLetterSp],maxSize[50]]','PlaceHolder'=>__('Enter Last Name')));?>
							</div>
				...
				<div class="form-group">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<?php echo $this->Form->input('relation', array('name'=>'relation','class'=>'form-control validate[required,maxSize[20]]','options' => array('Father'=>__('Father'),'Mother'=>__('Mother'),'Other'=>__('Other ')),'empty' => __('(choose one)'),'default'=>$relation));?>
							</div>			
				</div>
				...
				<div class="form-group">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<?php echo $this->Form->input('address',array('value'=>$it['address'],'name'=>'address','class'=>'form-control validate[required,maxSize[150]]','PlaceHolder'=> __('Enter Valid Address')));?>
							</div>

							<div class="col-md-2 col-sm-2 col-xs-12 label_float"><?php echo $this->Form->label(__('Select State '));?></div>
							<div class="col-md-4 col-sm-4 col-xs-12">
								<?php echo $this->Form->input('state', array('value'=>$it['state'],'name'=>'state','class'=>'form-control'));?>
							</div>
				</div>
				<div class="form-group">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<?php echo $this->Form->input('city', array('value'=>$it['city'],'name'=>'city','class'=>'form-control validate[required,maxSize[50]]'));?>
							</div>
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<?php echo $this->Form->input('zip_code',array('value'=>$it['zip_code'],'name'=>'zip_code','class'=>'form-control validate[required,maxSize[10]]','PlaceHolder'=>'Enter Pin Code'));?>
							</div>
				</div>
				...
				<div class="form-group">
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<?php echo $this->Form->input('mobile_no',array('value'=>$it['mobile_no'],'name'=>'mobile_no','class'=>'form-control validate[custom[onlyNumberSp],maxSize[15]]','PlaceHolder'=>'Enter Mobile Number'));?>
							</div>
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<?php echo $this->Form->input('phone1',array('value'=>$it['phone'],'name'=>'phone','class'=>'form-control validate[required,custom[onlyNumberSp],maxSize[15]]','PlaceHolder'=>'Enter Phone Number'));?>
							</div>
				</div>
				...
				<div class="form-group">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<?php echo $this->Form->input('email1',array('value'=>$it['email'],'name'=>'email','class'=>'form-control validate[required,custom[email],maxSize[50]]','PlaceHolder'=>'Enter Valid Email'));?>
							</div>
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<?php echo $this->Form->input('username',array('readonly','value'=>$it['username'],'name'=>'username','class'=>'form-control validate[maxSize[50]]'));?>
							</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
						...
						?>
								<?php echo $this->Form->input('image2',array('type'=>'hidden','value'=>$it['image'],'name'=>'image2'));?>
