			...
			<div class="scroll" style="height: 200px;overflow-y:scroll;">
					...
					<?php 
						if(!empty($model_data))
						{
							...
							{
								?>
								<tr id="term-<?php echo $retrive_data['class_section_id'];?>">
									<td><?php echo $retrive_data['section_name'];?></td>
									<td>

									<a class="widget-icon widget-icon-dark edit-term" href="#" 
									data-type="<?php echo $model;?>"
									data-id="<?php echo $retrive_data['class_section_id'];?>">
	  	 	...
	  	 	<div class="form-group">
				<label class="col-md-3 col-sm-6 col-xs-12 control-label" for="fee_type"> <?php echo __('Section Name'); ?> <span class="require-field" style="line-height: 30px;">*</span></label>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input id="txtfee_type" class="form-control text-input" type="text" value="" name="txtfee_type" maxlength="20" placeholder="">
				</div>
				<input value="<?php echo $model;?>" type="Hidden" id="class_id">
				<div class="col-md-3 col-sm-6 col-xs-12">
					<a class="btn btn-default btn-add-cat" href="#" style="float: left;width: auto;border-radius: 0;padding: 5px 10px;box-shadow: none;font-size: 14px;line-height: 18px;margin: 2px 0;"><?php echo __('Add New Section'); ?></a>
				</div>
			</div>			
</div>
