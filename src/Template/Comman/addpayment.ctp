				...
				<ul role="tablist" class="nav nav-tabs panel_tabs">
					...
					{ ?>
					  ...
					  <li class="active">					  
						<?php  
						if(isset($edit))
							echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-plus-circle fa-lg')) . " $link_name",array('controller'=>'Comman','action' => 'addpayment',$this->Setting->my_simple_crypt($row['payment_id'],'e')),array('escape' => false));
						else
							echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-plus-circle fa-lg')) . " $link_name",array('controller'=>'Comman','action' => 'addpayment'),array('escape' => false));?>
					  </li>
					  <li>
					  ...
					  <li>
						<?php  echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-list fa-lg')) . " Expense List",array('controller'=>'Comman','action' => 'expenselist'),array('escape' => false));?>
					  </li>
					  <li>
						<?php  echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-plus-circle fa-lg')) . " Add Expense",array('controller'=>'Comman','action' => 'addexpense'),array('escape' => false));?>
					  </li>
					 <?php } ?>
			...
			<?php echo $this->Form->Create('form1',['id'=>'formID','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'addpayment']]);?>
				...
				<div class="form-group">
							...
							<div class="col-md-10 col-sm-10 col-xs-12">
								<?php echo $this->Form->input('',array('name'=>'payment_title','value'=>$title_name,'id'=>'payment_title','class'=>'form-control validate[required,maxSize[50]] payment_title','PlaceHolder'=>''));?>
							</div>
				</div>
				...
				<div class="form-group">
							...
							<div class="col-md-10 col-sm-10 col-xs-12">
								<?php echo $this->Form->input('',array('name'=>'amount','value'=>$amount,'class'=>'form-control validate[required,custom[onlyNumberSp],maxSize[8]]','PlaceHolder'=>'Enter Amount'));?>
							</div>
				</div>
				...
				<div class="form-group">
							...
							<div class="col-md-10 col-sm-10 col-xs-12">
								<?php echo $this->Form->input('',array('name'=>'description','value'=>$desc,'id'=>'message','type'=>'textarea','class'=>'form-control validate[maxSize[500]]','PlaceHolder'=>'Enter Description'));?>
							</div>
				</div>
				...
				<div class="form-group">
							...
							<?php echo $this->Form->input($btnn,array('type'=>'submit','name'=>'add','class'=>'btn btn-success'));?>
							</div>
				</div>
			<?php $this->Form->end(); ?>
