...
<div class="row">
	<ul role="tablist" class="nav nav-tabs panel_tabs">	
		...
		<li class="active">		
			<?php  echo $this->Html->link($this->Html->tag('i', '  ', array('class' => 'fa fa-pencil-square-o fa-lg')) . __('Edit Route'),['controller' => 'Classroute', 'action' => 'updateclassroute',$this->Setting->my_simple_crypt($it['route_id'],'e')],['escape' => false]);?>
		</li>
		<li>		
		...
		<div class="panel-body">
			<?php echo $this->Form->create('$it',['id'=>'formID','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'']]);?>				
				...
				<div class="form-group">
							...
							<div class="col-md-10 col-sm-10 col-xs-12">
							<?php $a=$it['weekday'];?>
								<?php echo $this->Form->input('', array('name'=>'weekday','class'=>'form-control validate[required,maxSize[10]]','options' => array('1'=> __('Monday'),'2'=> __('Tuesday'),'3'=> __('Wednesday'),'4'=> __('Thursday'),'5'=> __('Friday'),'6'=> __('Saturday'),'7'=> __('Sunday')),'default'=>$a));?>
							</div>
				</div>
				<div class="form-group">
							...
							<div class="col-md-2 col-sm-2 col-xs-12">
								<?php echo $this->Form->input('', array('id'=>'start_ampm','name'=>'start_ampm','class'=>'form-control validate[required]','options' => array('am'=> __('am'),'pm'=> __('pm')),'default'=>$a1[2]));?>
							</div>
				...
				<div class="form-group">
							...
							<div class="col-md-2 col-sm-2 col-xs-12">
								<?php echo $this->Form->input('', array('id'=>'end_ampm','name'=>'end_ampm','class'=>'form-control validate[required]','options' => array('am'=> __('am'),'pm'=> __('pm')),'default'=>$a1[2]));?>
							</div>
				</div>
				<div class="form-group">
							...
							<div class="col-md-offset-2 col-sm-offset-2 col-xs-offset-0 col-md-10 col-sm-10 col-xs-12">
								<?php echo $this->Form->input(__('Save Route'),array('type'=>'submit','id'=>'update_class_route','name'=>'add','class'=>'btn btn-success'));?>
							</div>
				</div>
			<?php $this->Form->end(); ?>
...
<script>
$(document).ready(function(){
	$( "#update_class_route" ).on("click",function(e) {
