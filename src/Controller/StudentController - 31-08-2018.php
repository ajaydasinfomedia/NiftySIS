						...
						<div id="collapse_<?php echo $i;?>" class="panel-collapse collapse" aria-labelledby="heading_<?php echo $i;?>" role="tabpanel" aria-expanded="true" style="height: 0px;">
								...
								<?php if(isset($get_current_user_id)) {?>
									...
									<?php }else 
										{
											?>
									<div class="print-button pull-right"> <a href="?dashboard=user&page=student&print=pdf&student=<?php echo $user_id;?>&exam_id=<?php echo $exam_id;?>" target="_blank" class="btn btn-info"><?php echo __('PDF'); ?></a> <a href="?dashboard=user&page=student&print=print&student=<?php echo $user_id;?>&exam_id=<?php echo $exam_id;?>" target="_blank" class="btn btn-info"><?php echo __('Print'); ?></a> </div>
									<?php 
									...
									<div class="table-responsive">
										<table class="table table-bordered">
										  <tr>
											...
											<th><?php echo __('Obtain Mark (Out of '.$total_mark.')')?></th>
											<?php				  
											if($total_mark == 100)
											{
											?>
											<th><?php echo __('Grade')?></th>
											<th><?php echo __('Grade Comment')?></th>
											<?php
											}
											?>
										  </tr>
...
<?php
	...
	/* 	ob_start(); */
		...
		if($exists && $exists1)
		{
			...
			<div style="border: 1px solid gray; margin-right: auto ! important; margin-bottom: 0px ! important; margin-left: auto ! important; margin-top: 1%; width: 80%;">
			<div style="float: left; width: 100%;text-align: center;"><img src="<?php echo $this->request->webroot;?>img/<?php echo $vl['school_logo']; ?>"  style="max-height: 100px; margin: 0px auto;float: none;"/></div>
			<div style="float: right; width: calc(100% - 230px); font-size: 25px; margin-top: 15px;"><?php echo $vl['school_name'];?></div>
			...
			<div style="float: left; padding: 10px 0px; width: 100%;">
			  <div style="text-align: left; float: left; padding-left: 1%; width: 69%; font-size: 20px;">
				<p>
				  <?php echo __('Name');?>
					:
				...
				<p>
				 <?php echo __('Student ID');?>
					: <?php echo $studentID;?></p>
				<p>
				 <?php echo __('Class');?>
					:
					<?php 
							echo $classname=$this->Setting->get_class_id($class_id);
									?>
				</p>
				<p>
				 <?php echo __('Exam Name');?>
					:
					<?php 
							echo $this->Setting->get_exam_name($exam_id);
									?>
				</p>
			  </div>
			  <div style="float: right; width: 20%;"> <img src="<?php echo $this->request->base;?>/webroot/img/<?php echo $profile;?>"style="width: 100px;float: right;"/></div>
			  
			</div>
			<br>
			<table style="border: 1px solid rgb(0, 0, 0); width: 99%; margin: 0px auto ! important; font-size: 20px; text-align: center ! important;">
				<thead>
				  <tr style="border-bottom: 1px solid #000;">
					<th style="border-bottom: 1px solid rgb(0, 0, 0); border-right: 1px solid rgb(0, 0, 0); font-size: 18px;"><?php echo __('S/NO');?></th>
					<th style="border-bottom: 1px solid rgb(0, 0, 0); border-right: 1px solid rgb(0, 0, 0); font-size: 18px;"><?php echo __('Subject')?></th>
					<th style="border-bottom: 1px solid rgb(0, 0, 0); border-right: 1px solid rgb(0, 0, 0); font-size: 18px;"><?php echo __('Obtain Mark (Out of '.$total_mark.')')?></th>
					<?php				  
					if($total_mark == 100)
					{
					?>
					<th style="border-bottom: 1px solid rgb(0, 0, 0); border-right: 1px solid rgb(0, 0, 0); font-size: 18px;"><?php echo __('Grade')?></th>
					<?php
					}
					?>
				 </tr>
				</thead>
				<tbody style="font-size: 20px;text-align: center !important;">
					<?php
						$i=1;
						$total=0;
						$grade_point = 0;
					...
					?>
						<tr style="border-bottom: 1px solid #000;">
							...
							<td style="border-bottom: 1px solid #000;border-right: 1px solid #000;"><?php echo $mark;?> </td>
							<?php				  
							if($total_mark == 100)
							{
							?>
							<td style="border-bottom: 1px solid #000;border-right: 1px solid #000;"><?php echo $get_grade;?></td>
							<?php
							}
							?>
						</tr>
				  ...
				  <p style="font-size: 20px; margin-left: 5px;" class="result_total">
					<?php echo __("<B>Total Marks</B>");
					echo " : ".$total;?>
				  </p>
				  <?php				  
				  if($total_mark == 100)
				  {
				  ?>
				  <p style="font-size:20px; margin-left: 5px;" class="result_point">
					<?php echo __("<B>GPA ( Grade Point Average )</B>");
	...
	public function studentreceipt($id)
	{
		...
		if($id)
		{
			...
			{								
				...
				<div style="float:left; width: 100%;">
				<table width=100% class="count borderpx" style="background:#F2DBDB">
					<thead>
					</thead>
					<tbody>
						<tr>					
							<td rowspan=4  style="text-align:center;border-right : 1px solid #d5d5d5;">
								<img src="<?php echo $this->request->base.'/webroot/img/'.$this->Setting->get_user_image($user_id);?>" width="100px" height="100px"/>	
							</td>
							<td colspan=2 style="background: #D99594;border-bottom : 1px solid #d5d5d5;">
								<strong><?php echo __('Candidate Name : ');?></strong><?php echo $this->Setting->get_user_full_name($user_id);?>
							</td>
						</tr>
						<tr>
							<td style="background: #D99594;border-bottom : 1px solid #d5d5d5;border-right : 1px solid #d5d5d5;" align="left">
								<strong><?php echo __('Student ID : ');?></strong><?php echo $this->Setting->get_studentID($user_id);?>												
							</td>
							<td style="background: #D99594;border-bottom : 1px solid #d5d5d5;" align="left">	
								<strong><?php echo __('Roll No : ');?></strong><?php echo $this->Setting->get_user_roll_no($user_id);?>
							</td>
						</tr>
						<tr>
							<td style="background: #D99594;border-bottom : 1px solid #d5d5d5;border-right : 1px solid #d5d5d5;" align="left">
								<strong><?php echo __('Class : ');?></strong><?php echo $this->Setting->get_class_id($this->Setting->get_class_list_user_id($user_id));?>						
							</td>
							<td style="background: #D99594;border-bottom : 1px solid #d5d5d5;" align="left">
								<strong><?php echo __('Section : ');?></strong><?php echo $this->Setting->section_name($this->Setting->get_user_section_id($user_id));?>
							</td>
						</tr>
						<tr>
							<td style="background: #D99594;border-right : 1px solid #d5d5d5;" align="left">
								<strong><?php echo __('Start Date : ');?></strong><?php echo date($stud_date,strtotime($this->Setting->get_exam_data($exam_id,'exam_date')));?> 						
							</td>
							<td style="background: #D99594;border-bottom:0" align="left">
				...
				<table width=100% class="count borderpx" style="background:#F2DBDB">
					...
					<tbody>
						<tr>					
							<td style="background: #D99594;border-bottom : 1px solid #d5d5d5;">
						...
						<tr>
							<td style="background: #D99594;border-bottom:0">
				...
				?>
					...
					<table width=100% class="count borderpx" style="background:#F2DBDB;">
						<thead>
							<tr>
								<th colspan=5 style="background: #D99594;border-bottom : 1px solid #d5d5d5;">
									<?php echo __('Time Table For Exam Hall');?>
								</th>
							</tr>
							<tr>
								<th style="text-align:center;border-bottom : 1px solid #d5d5d5;"><?php echo __('Subject Code');?></th>
								<th style="text-align:center;border-bottom : 1px solid #d5d5d5;"><?php echo __('Subject');?></th>
								<th style="text-align:center;border-bottom : 1px solid #d5d5d5;"><?php echo __('Exam Date');?></th>
								<th style="text-align:center;border-bottom : 1px solid #d5d5d5;"><?php echo __('Exam Time');?></th>
								<th style="text-align:center;border-bottom : 1px solid #d5d5d5;"><?php echo __('Examiner Sign.');?></th>
							</tr>
						</thead>
						<tbody>
						<?php
						...
						?>
							<tr>
								<td style="text-align:center;border-bottom : 1px solid #d5d5d5;"><?php echo $this->Setting->get_subject_data($time_table['subject_id'],'sub_code');?></td>
								<td style="text-align:center;border-bottom : 1px solid #d5d5d5;"><?php echo $this->Setting->get_subject_data($time_table['subject_id'],'sub_name');?></td>
								<td style="text-align:center;border-bottom : 1px solid #d5d5d5;"><?php echo date($stud_date,strtotime($time_table['exam_date']));?></td>
								<td style="text-align:center;border-bottom : 1px solid #d5d5d5;"><?php echo $time_table['start_time']." To ".$time_table['end_time'];?></td>
								<td style="text-align:center;border-bottom : 1px solid #d5d5d5;"></td>
							</tr>
						<?php
						}
						?>
				...
				?>
				<br/><br/><br/>
				<div style="float:left;width:30%;padding-top:40px;">			
					<h2><span class="sign" style="border-top:1px solid;padding-top: 5px;"><?php echo __('Candidate Signature');?></span></h2>
				</div>
				<div style="float:right;width:40%;text-align:right;padding-top:40px;">
					<h2><span class="sign" style="border-top:1px solid;padding-top: 5px;"><?php echo __('Authorized Signature');?></span></h2>
				</div>
