...
<div class="row">			
	<ul role="tablist" class="nav nav-tabs panel_tabs">
		...
		<li class="">
			<?php  
			if(isset($edit))
				echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-plus-circle fa-lg')) . __('Edit Hostel'),array('controller'=>'Hostel','action' => 'addhostel',$this->Setting->my_simple_crypt($row['hostel_id'],'e')),array('escape' => false));
			else
		...
		<li class="active">
			...
			if(isset($edit))
				...
				echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-plus-circle fa-lg')) . __('Assign Room'),array('controller'=>'Hostel','action' => 'assignroom'),array('escape' => false));
			?>
		</li>
		<li class="">
			...
			if(isset($cls))
			{
				...
				?>
					...
					<div class="form-group">
						...
						<div class="col-md-2 col-sm-2 col-xs-12">
						<?php 
						echo $this->Html->link(__('Delete'),array('action' => 'assign_room_delete',$student['room_unique_id'],$student['bed_unique_id'],$student['student_id']),array('class'=>'btn btnview btn-danger','confirm' => 'Are you sure you wish to delete this Record?'));
						?>
						</div>
						<?php
						}
				...
				<div class="form-group">
					...
					<?php 
						...
						echo $this->Form->input(__('Assign Room'),array('type'=>'submit','name'=>'Assign_bed','id'=>'Assign_bed','class'=>'btn btn-success'));
					?>
					</div>
				</div>
			<?php 
