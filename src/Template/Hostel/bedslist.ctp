		...
		<div id="example_wrapper" class="dataTables_wrapper">
			<table id="exportlist" class="table table-striped" cellspacing="0" width="100%">
				...
				<tbody>
					...
					?>
					<tr>
						<td><input type="checkbox" class="checkbox ch_pend" name="id[]" dataid="<?php echo $get_data['bed_id'];  ?>"> </td>
						...
						<td>
						<?php 
						echo $this->Html->link(__('Edit'),array('controller'=>'Hostel','action' => 'addbeds',$this->Setting->my_simple_crypt($get_data['bed_id'],'e')),array('class'=>'btn btnview btn-info')) 
						."&nbsp;".
						$this->Form->button( __('Delete'),['action'=>'#','url'=>$this->request->base.'/'.$this->name.'/beds_delete/'.$get_data['bed_id'],'class'=>'btn btn-danger sa-warning']);
						?></td>
				...
				<tr>
					<td><button type="button" class="btn btn-danger" id="del_beds"> <?php echo __('Delete Selected'); ?> </button></td>
				</tr>
		</div>
	</div>
</div>
