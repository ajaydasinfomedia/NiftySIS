<?php
		...
		header('Content-Disposition: inline; filename="expense"');
		...
		$mpdf->WriteHTML('
			...
			<div class="mainarea">
				...
				<div class="lastdiv">
					<div class="textcr first" style="margin-top: 15px;padding:0px;background-color: #03A9F4;color:#FFFFFF;font-size:15px;text-transform:uppercase;">Invoice <br><b style="text-align:right;color:#FFFFFF;font-size:15px;padding:0px;">#'.$expense_data['income_id'].'</b></div>
