...
<div class="row schooltitle">			
	<ul role="tablist" class="nav nav-tabs panel_tabs">				  
		<li class="active">		
			<?php  echo $this->Html->link($this->Html->tag('i', '  ', array('class' => 'fa fa-list-ul fa-lg')) . __('Submission List'),['controller' => 'Comman', 'action' => 'viewsubmission',$this->Setting->my_simple_crypt($id,'e')],['escape' => false]);?>
		</li>
		<li>		
