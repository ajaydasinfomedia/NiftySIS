...
<div class="row schooltitle">			
	<ul role="tablist" class="nav nav-tabs panel_tabs">				  
		...
		<li class="active">		
			<?php  
			if(isset($edit))
				echo $this->Html->link($this->Html->tag('i', '  ', array('class' => 'fa fa-plus-circle fa-lg')) . __('Edit Homework'),['controller' => 'Homework', 'action' => 'addhomework',$this->Setting->my_simple_crypt($row['homework_id'],'e')],['escape' => false]);
			else
				echo $this->Html->link($this->Html->tag('i', '  ', array('class' => 'fa fa-plus-circle fa-lg')) . __('Add Homework'),['controller' => 'Homework', 'action' => 'addhomework'],['escape' => false]);
			?>
		</li>
	</ul>	
</div>
