...
<div class="row schooltitle">			
	<ul role="tablist" class="nav nav-tabs panel_tabs">
		<li class="active">
			<?php  echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-list fa-lg')) . __('Exam Receipt List'),['controller'=>'Student','action' => 'studentexamlist',$this->Setting->my_simple_crypt($user_id,'e')],['escape' => false]);?>
		</li>
	</ul>
</div>
<?php
