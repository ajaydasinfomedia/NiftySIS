					...
					<tr>
							...
							<?php 
								...
								foreach($it as $it2):
									...
									elseif($role == 'student'){
										echo "<td>".$this->Form->button($this->Html->tag('i',"&nbsp;", array('class' => 'fa fa-users')). __('View Child'),['action'=>'parentchild','data-toggle'=>'modal','data-target'=>'#myModal','print'=>$it2['user_id'],'class'=>'btn btn-default btnview save'],['escape' => false])."</td>";
									}
									else{
										echo "<td></td>";
									}
